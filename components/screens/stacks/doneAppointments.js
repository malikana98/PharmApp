...
export function DoneAppointments(){
...
if (user !== null) {
  ...
  const q = query(collection(db,"Appointments_Done"), where("UserKey", "==", uid));
...
return (
    ...
    <Text style ={styles.Info}>Status: Done</Text>
    </View>
        ...
        return (
            ...
            <Text style ={styles.Info}>Date: {item.Date}</Text>
            <Text style ={styles.Info}>Notes: {item.Notes}</Text>
            <Text style ={styles.Info}>Status: Cancelled</Text>
            </View>
